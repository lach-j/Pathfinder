# Product Ideas Backlog Requirements

Ideas remain local-first, single-user by default, filesystem-first, and Git-aware. They are intentionally speculative until a future Pathfinder planning pass turns them into scoped implementation slices.
